...
import com.raasalgul.service.SequenceGeneratorService;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Users user = new Users( 
							 ...
							 encoder.encode(signUpRequest.getPassword()),
									 signUpRequest.getUserName(),signUpRequest.getFirstName(),
		...
		user.setUserId(String.valueOf(sequenceGeneratorService.generateSequence(user.SEQUENCE_NAME)));
		user.setRoles(roles);
